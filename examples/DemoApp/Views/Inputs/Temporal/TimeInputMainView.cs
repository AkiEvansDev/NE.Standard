...
/// <summary>
/// One time field, and every property that can be bound to it.
/// </summary>
/// <remarks><c>Format</c>, <c>Culture</c>, <c>FormatMessage</c>, <c>Step</c> and <c>FirstDayOfWeek</c> are unbindable and have no rows.</remarks>
internal sealed class TimeInputMainView : DemoMainView, IUIViewDefinition
{
    private const string MainGroup = nameof(DemoStandardController.MainGroup);
    private const string ValueGroup = nameof(TimeInputMainController.ValueGroup);
    private const string FieldGroup = nameof(TimeInputMainController.FieldGroup);
    private const string ContentGroup = nameof(TimeInputMainController.ContentGroup);
    private const string BadgeGroup = nameof(TimeInputMainController.BadgeGroup);
    private const string BorderGroup = nameof(TimeInputMainController.BorderGroup);

    public static string ViewKey => "demo.inputs.time-input.main";
    ...
    protected override ContainerComponent CreateOptions()
        => DemoUI.CreateOptions(
            ...
            DemoUI.CreateOptionSection(ValueGroup, "Value", nameof(TimeInputMainController.CycleValueOption)),
            DemoUI.CreateOptionSection(FieldGroup, "Field", nameof(TimeInputMainController.CycleFieldOption)),
            DemoUI.CreateOptionSection(ContentGroup, "Content", nameof(TimeInputMainController.CycleContentOption)),
            DemoUI.CreateOptionSection(BadgeGroup, "Badge", nameof(TimeInputMainController.CycleBadgeOption)),
            DemoUI.CreateOptionSection(BorderGroup, "Border", nameof(TimeInputMainController.CycleBorderOption))
        );
}
