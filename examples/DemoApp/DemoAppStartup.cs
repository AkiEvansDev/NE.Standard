...
public sealed class DemoAppStartup : UIStartupBase
{
    protected override void ConfigureApplication(UIApplicationBuilder application)
    {
        ...
        _ = application.Route<KeyValueActionMainView, KeyValueActionMainController>("/contents/key-value-action");
        _ = application.Route<KeyValueActionExamplesView>("/contents/key-value-action/examples");
        _ = application.Route<KeyValueActionScenariosView, KeyValueActionScenariosController>("/contents/key-value-action/scenarios");
