...
/** Marks the element as the one being dragged and gives the drag its payload; a stale mark in the scope is cleared first. */
export function markDragStart(domEvent: Event, scope: Element, element: HTMLElement, draggingClass: string, key: string): void {
