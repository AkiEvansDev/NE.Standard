...
internal sealed record RecursiveMemberModel(BasePropertyDeclarationSyntax PropertySyntax, IPropertySymbol Property, INamedTypeSymbol ContainingType, RecursiveMemberAttributeValues Values);
