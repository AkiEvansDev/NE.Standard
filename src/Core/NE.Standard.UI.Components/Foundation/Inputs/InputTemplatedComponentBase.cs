...
/// </summary>
public abstract partial class InputTemplatedComponentBase<TComponent, TItem, TValue>(string? id = null) : GroupedItemsComponentBase<TComponent, TItem>(id), IInputComponent, ITextBaseComponent
    where TComponent : InputTemplatedComponentBase<TComponent, TItem, TValue>, IUIComponentDefinition
    where TItem : class
{
